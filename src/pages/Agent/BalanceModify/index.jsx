...
class Page extends Component {
  ...
  columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <div>
          {parseFloat(text)} {record.charge_asset}
        </div>
      ),
    },
    // {
  ...
  loadData = () => {
    ...
    this.props.dispatch({
      type: 'agentBalanceModify/queryList',
      payload: {
        page: page,
        count: count,
        search: search,
    ...
    return (
      <div>
        ...
        <OperationGroup
          onExport={all => {
            this.props.dispatch({
              type: 'agentBalanceModify/export',
              payload: {
                page: page,
                count: count,
...
function mapStateToProps(state) {
  return {
    data: state.agentBalanceModify.list,
    listLoading: state.loading.effects['agentBalanceModify/queryList'],
  };
}
