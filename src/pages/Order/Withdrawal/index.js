...
class Page extends Component {
  ...
  render() {
    const { page, count, search } = this.state;
    const { data, listLoading, updateLoading, usdt, fil } = this.props;
    return (
      <div>
        <SearchGroup
          onSearch={e => {
        ...
        {fil && (
          <div className={styles.balance}>提币地址： {parseFloat(fil)} FIL</div>
        )}
        <EditableTable
